  ...
  return (
    <>
        ...
        <Container className="relative">
          <FadeIn>
            <div className="mx-auto max-w-3xl text-center">
              <Badge variant="primary" className="mb-6">Now generally available</Badge>
      ...
      <section className="py-16 border-y border-border">
        <Container>
          <FadeIn>
            <LogoCloud title="Connects with the tools your teams already use" />
          </FadeIn>
        </Container>
      </section>
            ...
            {pillars.map((pillar, i) => (
              <FadeIn key={pillar.slug} delay={i * 0.1}>
                <Link
                  ...
                  className="group flex flex-col rounded-2xl border border-border bg-card p-8 transition-all duration-200 hover:shadow-lg hover:border-primary/20 h-full"
                >
