      ...
      <section style={{padding:"72px 0 80px",background:"#000814"}}>
        <div style={{maxWidth:700,margin:"0 auto",padding:"0 24px",textAlign:"center"}}>
          ...
          <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
            <Link href="/about/contact" style={{display:"inline-flex",alignItems:"center",padding:"13px 28px",background:B,color:"#FFFFFF",borderRadius:10,fontSize:15,fontWeight:600,fontFamily:F,textDecoration:"none"}}>Request a demo →</Link>
            <Link href="/solutions" style={{display:"inline-flex",alignItems:"center",padding:"12px 26px",background:"transparent",color:"rgba(255,255,255,0.88)",border:"1.5px solid rgba(255,255,255,0.3)",borderRadius:10,fontSize:15,fontWeight:600,fontFamily:F,textDecoration:"none"}}>Explore solutions</Link>
          </div>
        </div>
      </section>
    </main>
